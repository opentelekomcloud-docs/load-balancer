...
You have a web application that is deployed on separated ECSs but uses the same domain name for access. Two different URLs are required to process requests.
