...
ELB allows you to use a whitelist or blacklist for access control. If you want to configure an :ref:`access control <en-us_elb_03_0003>` policy, you must select an IP address group.
