...
|             |           |        |    brackets (< and >).                    |
+-------------+-----------+--------+-------------------------------------------+
| domain      | No        | String | -  Specifies the domain name associated   |
...
|             |           |        |    or digits.                             |
+-------------+-----------+--------+-------------------------------------------+
| certificate | Yes       | String | -  Specifies the certificate content.     |
|             |           |        |                                           |
|             |           |        | -  The value is in PEM coding format.     |
+-------------+-----------+--------+-------------------------------------------+
| private_key | Yes       | String | -  Specifies the private key of the       |
|             |           |        |    certificate.                           |
|             |           |        |                                           |
|             |           |        | -  The value is in PEM coding format.     |
+-------------+-----------+--------+-------------------------------------------+
...
|             |        | certificate.                                |
+-------------+--------+---------------------------------------------+
| create_time | String | Specifies the time when the certificate was |
|             |        | created.                                    |
+-------------+--------+---------------------------------------------+
