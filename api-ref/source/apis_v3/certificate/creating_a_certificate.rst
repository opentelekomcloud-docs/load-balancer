...
.. table:: **Table 4** CreateCertificateOption
   ...
   |                       |                 |                 | Maximum: **255**                                                                                                                                                                                                                                 |
   +-----------------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | private_key           | No              | String          | Specifies the private key of the certificate used by HTTPS. This parameter is valid and mandatory only when **type** is set to **server**. The value must be PEM encoded. Maximum 8,192 character length is allowed.                             |
   +-----------------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | project_id            | No              | String          | Specifies the project ID of the certificate.                                                                                                                                                                                                     |
   |                       |                 |                 |                                                                                                                                                                                                                                                  |
   |                       |                 |                 | Minimum: **1**                                                                                                                                                                                                                                   |
   |                       |                 |                 |                                                                                                                                                                                                                                                  |
   |                       |                 |                 | Maximum: **32**                                                                                                                                                                                                                                  |
